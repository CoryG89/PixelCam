...
ClosePixelation.render = function ( canvas, options ) {
  for ( var i=0, len = options.length; i < len; i++ ) {
    ClosePixelation.renderClosePixels( canvas, options[i] )
  }
}

ClosePixelation.renderClosePixels = function ( canvas, opts ) {
  var w = canvas.width
  var h = canvas.height
